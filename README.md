...
- SSH keys should be generated for use with this deployment
    ```
        ssh-keygen -f ./tftest
    ```
...
| DO_URL | Yes | This is the raw github URL for downloading the DO RPM |
| AS3_URL | Yes | This is the raw github URL for downloading the AS3 RPM. |
| TS_URL | Yes | This is the raw github URL for downloading the TS RPM. |
