...
resource "azurerm_network_security_group" "mgmt_sg" {
...
resource "azurerm_network_interface" "mgmt-nic" {
    ...
    location                  = azurerm_resource_group.main.location
    resource_group_name       = azurerm_resource_group.main.name
    #network_security_group_id = azurerm_network_security_group.mgmt_sg.id
...
# Create public IPs for BIG-IP mgmt UI
